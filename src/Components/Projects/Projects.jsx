    ...
    <div id="projects" className="project">
      ...
      <div className="inner-project">
        ...
        <div className="project-description">
          ...
          <p>
            This project is a clone of "www.buywow.in", which is a health,
            grooming, and beauty Products website.
          </p>
          <p>
            <br />
            <h2>Features:-</h2>
          ...
          <div className="live-links">
            <a
              target="_blank"
              href="https://dazzling-horse-5169fb.netlify.app/"
            >
              <BsRocketTakeoff /> Live Site
            </a>
            <a
      ...
      {/* <div className="inner-project">
        ...
        <div className="project-description">
          ...
          <p>
            DnaIndia is news website. Latest News Headlines and Live Updates -
            DNA India Covers all latest and breaking news on Politics, Business,
            Sports, Bollywood, technology & health.
          </p>
          <p>
            <br />
            <h2>Features:-</h2>
          ...
          <p>HTML | CSS | Javascript | React | Redux | Chakra</p>
          <div className="live-links">
            <a target="_blank" href="https://dna-india-clone-nine.vercel.app/">
              <BsRocketTakeoff /> Live Site
            </a>
            <a
              target="_blank"
              href="https://github.com/SayedMajid/dnaIndiaClone"
            >
